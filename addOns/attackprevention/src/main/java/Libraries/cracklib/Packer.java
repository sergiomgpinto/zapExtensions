...
public class Packer implements Closeable {
  ...
  public Packer(String name, String mode) throws IOException
  {
    ...
    dataFile = new RandomAccessFile (zapExtPath+"/zap-extensions/addOns/attackprevention/src/main/resources/org/zaproxy/addon/attackprevention/resources/database/wordsDictCrackLib.pwd", mode);
    indexFile = new RandomAccessFile(zapExtPath+"/zap-extensions/addOns/attackprevention/src/main/resources/org/zaproxy/addon/attackprevention/resources/database/wordsDictCrackLib.pwi",mode);
