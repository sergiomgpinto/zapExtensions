...
tasks.register<TestReport>("testReport") {
    ...
    doLast {
        val reportUrl = File(destinationDirectory.get().getAsFile(), "warning.html").toURL()
...
val jacocoReport by tasks.registering(JacocoReport::class) {
    ...
    doLast {
        val reportUrl = File(reports.html.outputLocation.get().getAsFile(), "warning.html").toURL()
